...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Deptos MDQ · Gestión Airbnb & Booking" },
      { name: "description", content: "Gestión de reservas, calendario y finanzas de tus departamentos en Mar del Plata." },
      { property: "og:title", content: "Deptos MDQ" },
      { property: "og:description", content: "Gestión de reservas y calendario de tus departamentos." },
